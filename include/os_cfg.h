...
#define OS_MAX_EVENTS             1      //应用程序中事件控制块的最大数量,必须 > 0
#define OS_MAX_FLAGS              1      //应用程序中事件标志组的最大数量,必须 > 0
#define OS_MAX_MEM_PART           1      //内存分区的最大数量,必须 > 0
#define OS_MAX_QS                 1      //应用程序中队列控制块的最大数量,必须 > 0
